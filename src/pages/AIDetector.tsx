...
const AIDetector = () => {
  ...
  const handleDetection = async () => {
    if (!inputText.trim()) {
      toast({
        title: t("aiDetector.pleaseInputText"),
        description: t("aiDetector.pleaseInputTextDesc"),
        variant: "destructive",
      });
      return;
    }
    ...
    if (inputText.trim().length < 50) {
      toast({
        title: t("aiDetector.inputTooShort"),
        description: t("aiDetector.inputTooShortDesc"),
        variant: "destructive",
      });
      return;
    }
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500">
                  {inputText.length} {t("aiDetector.charactersCount")}
                </span>
                <Button 
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          <div className="text-sm text-gray-600 dark:text-gray-300">{t("aiDetector.alternativeCandidate")}</div>
